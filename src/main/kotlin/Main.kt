...
fun main() {
    ...
    val libro1 = Libro(133, "City of Glass", "Paul Auster", 1992, "Detectivesca")
    val libro2 = Libro(134, "The Mark on the Wall", "Virginia Woolf", 1981, "Psicológica")
    val libro3 = Libro(135, "Brave New World", "Aldous Huxley", 1966, "Ficción")
